...
function NzQRCodeComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NzQRCodeComponent_Conditional_0_Case_1_Template, 1, 0)(2, NzQRCodeComponent_Conditional_0_Case_2_Template, 7, 2);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
    ...
    ɵɵadvance();
    ɵɵconditional(1, (tmp_1_0 = ctx_r1.nzStatus) === "loading" ? 1 : tmp_1_0 === "expired" ? 2 : -1);
  }
}
...
_NzQRCodeComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function NzQRCodeComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtemplate(0, NzQRCodeComponent_Conditional_0_Template, 3, 1, "div", 1)(1, NzQRCodeComponent_Conditional_1_Template, 2, 0, "canvas");
    }
    if (rf & 2) {
